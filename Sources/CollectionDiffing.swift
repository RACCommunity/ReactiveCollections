...
extension Signal where Value: Collection, Value.Iterator.Element: Hashable, Value.Indices.Iterator.Element == Value.Index {
	...
	public func diff() -> Signal<Snapshot<Value>, Error> {
...
extension Signal where Value: Collection, Value.Iterator.Element: AnyObject & Equatable, Value.Indices.Iterator.Element == Value.Index {
	...
	///
	/// - complexity: O(n) time and space.
	public func diff(comparingBy strategy: ObjectDiffStrategy = .value) -> Signal<Snapshot<Value>, Error> {
...
extension Signal where Value: Collection, Value.Iterator.Element: AnyObject & Hashable, Value.Indices.Iterator.Element == Value.Index {
	...
	///
	/// - complexity: O(n) time and space.
	public func diff(identifyingBy identifyingStrategy: ObjectDiffStrategy = .identity, comparingBy comparingStrategy: ObjectDiffStrategy = .value) -> Signal<Snapshot<Value>, Error> {
...
extension Signal where Value: Collection, Value.Indices.Iterator.Element == Value.Index {
	...
	///
	/// - complexity: O(n) time and space.
	public func diff<Identifier: Hashable>(identifier: @escaping (Value.Iterator.Element) -> Identifier, areEqual: @escaping (Value.Iterator.Element, Value.Iterator.Element) -> Bool) -> Signal<Snapshot<Value>, Error> {
		return Signal<Snapshot<Value>, Error> { observer in
			var previous: Value?
...
extension SignalProducer where Value: Collection, Value.Iterator.Element: Hashable, Value.Indices.Iterator.Element == Value.Index {
	...
	///
	/// - complexity: O(n) time and space.
	public func diff() -> SignalProducer<Snapshot<Value>, Error> {
		return lift { $0.diff() }
	}
}
...
extension SignalProducer where Value: Collection, Value.Iterator.Element: AnyObject & Equatable, Value.Indices.Iterator.Element == Value.Index {
	...
	///
	/// - complexity: O(n) time and space.
	public func diff(comparingBy strategy: ObjectDiffStrategy = .value) -> SignalProducer<Snapshot<Value>, Error> {
...
extension SignalProducer where Value: Collection, Value.Iterator.Element: AnyObject & Hashable, Value.Indices.Iterator.Element == Value.Index {
	...
	///
	/// - complexity: O(n) time and space.
	public func diff(identifyingBy identifyingStrategy: ObjectDiffStrategy = .identity, comparingBy comparingStrategy: ObjectDiffStrategy = .value) -> SignalProducer<Snapshot<Value>, Error> {
...
extension SignalProducer where Value: Collection, Value.Indices.Iterator.Element == Value.Index {
	...
	///
	/// - complexity: O(n) time and space.
	public func diff<Identifier: Hashable>(identifier: @escaping (Value.Iterator.Element) -> Identifier, areEqual: @escaping (Value.Iterator.Element, Value.Iterator.Element) -> Bool) -> SignalProducer<Snapshot<Value>, Error> {
...
extension PropertyProtocol where Value: Collection, Value.Iterator.Element: Hashable, Value.Indices.Iterator.Element == Value.Index {
	...
	///
	/// - complexity: O(n) time and space.
	public func diff() -> Property<Snapshot<Value>> {
		let value = self.value
		return Property(initial: Snapshot(previous: nil, current: value, changeset: Changeset(initial: value)),
		                then: producer.diff())
	}
}
...
extension PropertyProtocol where Value: Collection, Value.Iterator.Element: AnyObject & Equatable, Value.Indices.Iterator.Element == Value.Index {
	...
	///
	/// - complexity: O(n) time and space.
	public func diff(comparingBy strategy: ObjectDiffStrategy = .value) -> Property<Snapshot<Value>> {
		let value = self.value
		return Property(initial: Snapshot(previous: nil, current: value, changeset: Changeset(initial: value)),
		                then: producer.diff(comparingBy: strategy))
	}
}
...
extension PropertyProtocol where Value: Collection, Value.Iterator.Element: AnyObject & Hashable, Value.Indices.Iterator.Element == Value.Index {
	...
	///
	/// - complexity: O(n) time and space.
	public func diff(identifyingBy identifyingStrategy: ObjectDiffStrategy = .identity, comparingBy comparingStrategy: ObjectDiffStrategy = .value) -> Property<Snapshot<Value>> {
		let value = self.value
		return Property(initial: Snapshot(previous: nil, current: value, changeset: Changeset(initial: value)),
		                then: producer.diff(identifyingBy: identifyingStrategy,
		                                    comparingBy: comparingStrategy))
	}
}
...
extension PropertyProtocol where Value: Collection, Value.Indices.Iterator.Element == Value.Index {
	...
	///
	/// - complexity: O(n) time and space.
	public func diff<Identifier: Hashable>(identifier: @escaping (Value.Iterator.Element) -> Identifier, areEqual: @escaping (Value.Iterator.Element, Value.Iterator.Element) -> Bool) -> Property<Snapshot<Value>> {
		let value = self.value
		return Property(initial: Snapshot(previous: nil, current: value, changeset: Changeset(initial: value)),
		                then: producer.diff(identifier: identifier, areEqual: areEqual))
	}
}
